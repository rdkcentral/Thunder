...
namespace WPEFramework {
    ...
    ENUM_CONVERSION_BEGIN(enumTestType)
        { enumTestType::ENUM_1, _TXT("enum_1") },
        { enumTestType::ENUM_2, _TXT("enum_2") },
        { enumTestType::ENUM_3, _TXT("enum_3") },
        { enumTestType::ENUM_4, _TXT("enum_4") },
    ENUM_CONVERSION_END(enumTestType)
...
namespace Tests {
    ...
    public:
        ...
        Core::JSON::String C;
        Core::JSON::Boolean D;
        Core::JSON::EnumType<enumTestType> E;
    };
    ...
    public:
        ...
        WPEFramework::Core::JSON::EnumType<enumTestType> I;
    ...
    TEST(Core_JSON, smallParser)
    {
        ...
        }
        {
            ...
            command->F.G = -12;
            command->F.H = -44;
            command->F.I = enumTestType::ENUM_4;
