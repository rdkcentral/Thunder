...
ENUM_CONVERSION_BEGIN(Tests::Core::Purpose)
    { Tests::Core::Purpose::MEM, _TXT("mem") },
    { Tests::Core::Purpose::SWAP, _TXT("swap") },
    { Tests::Core::Purpose::HOST, _TXT("host") },
    { Tests::Core::Purpose::CHIPSET, _TXT("chipset") },
    { Tests::Core::Purpose::CPULOAD, _TXT("cpuload") },
ENUM_CONVERSION_END(Tests::Core::Purpose)

ENUM_CONVERSION_BEGIN(Tests::Core::Function)
    { Tests::Core::Function::TOTAL, _TXT("total") },
    { Tests::Core::Function::FREE, _TXT("free") },
    { Tests::Core::Function::AVAILABLE, _TXT("available") },
    { Tests::Core::Function::CACHED, _TXT("cached") },
ENUM_CONVERSION_END(Tests::Core::Function)
