...
if __name__ == "__main__":
    ...
    if args.help_tags:
        ...
        print("   @json:omit             - leaves a method out from JSON-RPC generation")
        ...
        print("   @alt {name}            - provides an alternative name the method can by called by")
        print("   @text {name}           - sets a different name for a parameter, enum, struct or method")
        ...
        print("   @deprecated            - tags a JSON-RPC method, property or event as deprecated in documentation")
        print("   @obsolete              - tags a JSON-RPC method, property or event as osbsolete in documentation")
        print("   @sourcelocation {lnk}  - sets source location link to be used in documentation")
        print("   @define {def}          - defines a literal as a known identifier")
        print("")
