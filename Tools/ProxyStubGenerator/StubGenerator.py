...
if __name__ == "__main__":
    ...
    if args.help_tags:
        ...
        print("   @extended             - marks a class to be generated in the obsolete 'extended' format")
        print("   @collapsed            - marks a class to be generated in the obsolete 'collapsed' format")
