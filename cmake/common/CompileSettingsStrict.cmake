...
if(ENABLE_STRICT_COMPILER_SETTINGS)
    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        ...
        set(_STRICT_OPTS -Wall -Wextra -Wpedantic -Werror -Wno-error=deprecated-declarations)
        set(_STRICT_CXX_OPTS -Werror=return-type -Werror=array-bounds -Wnon-virtual-dtor -Wmisleading-indentation)
        if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 12)
            list(APPEND _STRICT_CXX_OPTS -Wrange-loop-construct)
        endif()
    elseif(CMAKE_COMPILER_IS_GNUCXX)
        message(STATUS "Enabling strict compiler settings for GCC")
        set(_STRICT_OPTS -Wall -Wextra -Wpedantic -Werror -Wno-error=deprecated-declarations)
        set(_STRICT_CXX_OPTS -Wnon-virtual-dtor -Wmisleading-indentation)
        if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 12)
            list(APPEND _STRICT_CXX_OPTS -Wrange-loop-construct)
        endif()
    ...
    if(_STRICT_CXX_OPTS)
        message(VERBOSE "Adding strict cxx compiler options: ${_STRICT_CXX_OPTS}")
        if(CMAKE_VERSION VERSION_LESS "3.12")
            message(FATAL_ERROR "CMake 3.12 or higher is required for CXX-only compile options via generator expressions")
        endif()
        foreach(_OPT ${_STRICT_CXX_OPTS})
