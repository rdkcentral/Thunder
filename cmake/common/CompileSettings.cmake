...
if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    ...
    target_compile_options(CompileSettings INTERFACE -Weverything -Wextra -Wnon-virtual-dtor)
    target_compile_options(CompileSettings INTERFACE -Werror=return-type -Werror=array-bounds)
elseif(${CMAKE_COMPILER_IS_GNUCXX})
    message(STATUS "Compiling with GCC")
    target_compile_options(CompileSettings INTERFACE -Wall -Wextra -Wnon-virtual-dtor)
    target_compile_options(CompileSettings INTERFACE -Werror=return-type -Werror=array-bounds)
