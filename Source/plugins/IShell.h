...
namespace PluginHost {
    ...
    struct EXTERNAL IShell : virtual public Core::IUnknown {
       ...
       public:
        ...
        virtual void Register(IPlugin::INotificationExtended* sink, const uint32_t interface_id) = 0;
        virtual void Unregister(IPlugin::INotificationExtended* sink, const uint32_t interface_id) = 0;
