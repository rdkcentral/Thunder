    ...
    namespace PluginHost {
        ...
        struct EXTERNAL IDispatcher : public virtual Core::IUnknown {
            ...
            struct EXTERNAL ICallback : public virtual Core::IUnknown {
                ...
                virtual Core::hresult Event(const string& event, const string& parameters /* @restrict:16M */) = 0;
                virtual Core::hresult Error(const uint32_t channel, const uint32_t id, const uint32_t code, const string& message) = 0;
                virtual Core::hresult Response(const uint32_t channel, const uint32_t id, const string& response /* @restrict:16M */) = 0;
            ...
            virtual Core::hresult Validate(const string& token, const string& method, const string& paramaters /* @restrict:16M */) const = 0;
            virtual Core::hresult Invoke(ICallback* callback, const uint32_t channelId, const uint32_t id, const string& token, const string& method, const string& parameters /* @restrict:16M */, string& response /* @restrict:16M @out */) = 0;
