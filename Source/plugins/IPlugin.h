...
namespace PluginHost {
    ...
    struct EXTERNAL IPlugin : public virtual Core::IUnknown {
        ...
        struct INotification : virtual public Core::IUnknown {
            ...
            virtual void Suspended(VARIABLE_IS_NOT_USED const string& callsign, VARIABLE_IS_NOT_USED IShell* plugin) {};
            virtual void Resumed(VARIABLE_IS_NOT_USED const string& callsign, VARIABLE_IS_NOT_USED IShell* plugin) {};
        };
