...
#define PUSH_WARNING_ARG1(WARNING, ...) WARNING
#define PUSH_WARNING_ARG2(WARNING, ...) WARNING PUSH_WARNING_ARG1(__VA_ARGS__)
#define PUSH_WARNING_ARG3(WARNING, ...) WARNING PUSH_WARNING_ARG2(__VA_ARGS__)
#define PUSH_WARNING_ARG4(WARNING, ...) WARNING PUSH_WARNING_ARG3(__VA_ARGS__)
#define PUSH_WARNING_ARG5(WARNING, ...) WARNING PUSH_WARNING_ARG4(__VA_ARGS__)

#define PUSH_WARNING_ARG_N(_1, _2, _3, _4, _5, N, ...) N
#define PUSH_WARNING_NARG_STR() 5, 4, 3, 2, 1, 0
#define PUSH_WARNING_NARG(...) PUSH_WARNING_NARG_(__VA_ARGS__, PUSH_WARNING_NARG_STR())
#define PUSH_WARNING_NARG_(...) PUSH_WARNING_ARG_N(__VA_ARGS__)

#define PUSH_WARNING_ARG(N, ...) JOIN_WARNING_STR(PUSH_WARNING_ARG, N)(__VA_ARGS__)
#define PUSH_WARNING(...) \
    PUSH_WARNING_ PUSH_WARNING_ARG(PUSH_WARNING_NARG(__VA_ARGS__), __VA_ARGS__)
