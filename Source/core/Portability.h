...
namespace Thunder {
    ...
    struct EXTERNAL IUnknown : public IReferenceCounted  {
        ...
        static constexpr std::memory_order memory_order_consume = std::memory_order_consume;
        ...
        static constexpr std::memory_order memory_order_seq_cst = std::memory_order_seq_cst;
#endif
        }
