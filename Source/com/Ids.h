...
namespace RPC {
    ...
    enum IDS {
        ...
        ID_CONTROLLER_CONFIGURATION         = (ID_OFFSET_INTERNAL + 0x0010),
        ID_CONTROLLER_DISCOVERY             = (ID_OFFSET_INTERNAL + 0x0011),
        ID_CONTROLLER_SYSTEMINFO            = (ID_OFFSET_INTERNAL + 0x0012),
        ID_CONTROLLER_LIFETIME              = (ID_OFFSET_INTERNAL + 0x0013),
        ID_CONTROLLER_LIFETIME_NOTIFICATION = (ID_OFFSET_INTERNAL + 0x0014),
        ID_CONTROLLER_METADATA              = (ID_OFFSET_INTERNAL + 0x0015),
        ID_CONTROLLER_SYSTEM_MANAGEMENT     = (ID_OFFSET_INTERNAL + 0x0016),
