...
ProxyStub::MethodHandler AccesorOCDMStubMethods[] = {
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        response.Boolean(message->Parameters()
                             .Implementation<OCDM::IAccessorOCDM>()
                             ->IsTypeSupported(keySystem, mimeType));
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        ...
        response.Number<OCDM::ISession*>(
            message->Parameters().Implementation<OCDM::IAccessorOCDM>()->Session(
                sessionId));
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        if (param0_proxy != nullptr) {
            proxy = RPC::Administrator::Instance().ProxyInstance(
                channel, param0_proxy, OCDM::ISession::ICallback::ID, false,
                OCDM::ISession::ICallback::ID, true);
            param0_proxy = (proxy != nullptr
                    ? proxy->QueryInterface<OCDM::ISession::ICallback>()
                    : nullptr);
        ...
        response.Number(message->Parameters()
                            .Implementation<OCDM::IAccessorOCDM>()
                            ->CreateSession(keySystem, licenseType, initDataType,
                                initData, initDataLength, CDMData,
                                CDMDataLength, param0_proxy,
                                sessionId, result));
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        response.Number(message->Parameters()
                            .Implementation<OCDM::IAccessorOCDM>()
                            ->SetServerCertificate(keySystem, serverCertificate,
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        if (param0_proxy != nullptr) {
            proxy = RPC::Administrator::Instance().ProxyInstance(
                channel, param0_proxy, OCDM::IAccessorOCDM::INotification::ID,
                false, OCDM::IAccessorOCDM::INotification::ID, true);
            param0_proxy = (proxy != nullptr
                    ? proxy->QueryInterface<OCDM::IAccessorOCDM::INotification>()
                    : nullptr);

            ASSERT((param0_proxy != nullptr) && "Failed to create proxy");
        }

        message->Parameters().Implementation<OCDM::IAccessorOCDM>()->Register(
            param0_proxy);
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel,
        ...
        //
        // virtual void
        // Unregister(OCDM::IAccessorOCDM::INotificationISession::IKeyCallback*
        // callback) = 0;
        //
        ...
        message->Parameters().Implementation<OCDM::IAccessorOCDM>()->Unregister(
            param0_proxy);
...
ProxyStub::MethodHandler AccesorOCDMExtStubMethods[] = {
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        // virtual time_t GetDrmSystemTime(const std::string & keySystem) const =
        // 0;
        //
        RPC::Data::Frame::Reader parameters(message->Parameters().Reader());
        RPC::Data::Frame::Writer response(message->Response().Writer());
        ...
        response.Number(message->Parameters()
                            .Implementation<OCDM::IAccessorOCDMExt>()
                            ->GetDrmSystemTime(keySystem));
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        // virtual std::string GetVersionExt(const std::string & keySystem) const
        // = 0;
        //
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        OCDM::IAccessorOCDMExt* accessor = message->Parameters().Implementation<OCDM::IAccessorOCDMExt>();
        OCDM::OCDM_RESULT result = accessor->GetSecureStop(
            keySystem, sessionID, sessionIDLength, rawData, rawSize);
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        OCDM::IAccessorOCDMExt* accessor = message->Parameters().Implementation<OCDM::IAccessorOCDMExt>();
        response.Number(
            accessor->CommitSecureStop(keySystem, sessionID, sessionIDLength,
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        // virtual OCDM_RESULT TeardownSystemExt(const std::string & keySystem) =
        // 0;
        //
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        // virtual OCDM_RESULT DeleteSecureStore(const std::string & keySystem) =
        // 0;
        //
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        OCDM::OCDM_RESULT result = accessor->GetKeyStoreHash(
            keySystem, keyStoreHash, keyStoreHashLength);
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        OCDM::OCDM_RESULT result = accessor->GetSecureStoreHash(
...
//
// OCDM::IAccessorOCDM::INotification interface stub definitions
// (interface/ICDM.h)
//
ProxyStub::MethodHandler AccesorOCDMNotificationStubMethods[] = {
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        message->Parameters()
            .Implementation<OCDM::IAccessorOCDM::INotification>()
            ->Create(sessionId);
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        //     const string& sessionId, const uint8 keyId[], const uint8_t length)
        //     = 0;
        //
        RPC::Data::Frame::Reader parameters(message->Parameters().Reader());
        ...
        message->Parameters()
            .Implementation<OCDM::IAccessorOCDM::INotification>()
            ->KeyChange(sessionId, keyData, keyDataLength, status);
    },
    nullptr
};
...
ProxyStub::MethodHandler CallbackStubMethods[] = {
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        message->Parameters()
            .Implementation<OCDM::ISession::ICallback>()
            ->OnKeyMessage(buffer, length, URL);
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        message->Parameters()
            .Implementation<OCDM::ISession::ICallback>()
            ->OnKeyError(error, sysError, data);
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
...
ProxyStub::MethodHandler SessionStubMethods[] = {
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        response.Number(
            message->Parameters().Implementation<OCDM::ISession>()->Load());
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        ...
        message->Parameters().Implementation<OCDM::ISession>()->Update(buffer,
            length);
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        response.Number(
            message->Parameters().Implementation<OCDM::ISession>()->Remove());
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        ...
        response.Number(
            message->Parameters().Implementation<OCDM::ISession>()->Status());
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        ...
        response.Text(
            message->Parameters().Implementation<OCDM::ISession>()->BufferId());
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        message->Parameters().Implementation<OCDM::ISession>()->Revoke(
            param0_proxy);
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        response.Text(
            message->Parameters().Implementation<OCDM::ISession>()->SessionId());
    },
...
ProxyStub::MethodHandler SessionExtStubMethods[] = {
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        ...
        response.Number(message->Parameters()
                            .Implementation<OCDM::ISessionExt>()
                            ->SessionIdExt());
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        response.Text(message->Parameters()
                          .Implementation<OCDM::ISessionExt>()
                          ->BufferIdExt());
    },
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        // virtual OCDM_RESULT SetDrmHeader(const char drmHeader[], uint32_t
        // drmHeaderLength) = 0;
        //
        RPC::Data::Frame::Reader parameters(message->Parameters().Reader());
        RPC::Data::Frame::Writer response(message->Response().Writer());
        ...
        OCDM::OCDM_RESULT result = message->Parameters()
                                       .Implementation<OCDM::ISessionExt>()
                                       ->SetDrmHeader(drmHeader, length);
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        // virtual OCDM_RESULT GetChallengeDataExt(uint8_t * challenge, uint32_t *
        // challengeSize, uint32_t isLDL) = 0;
        //
        RPC::Data::Frame::Reader parameters(message->Parameters().Reader());
        RPC::Data::Frame::Writer response(message->Response().Writer());
        ...
        OCDM::OCDM_RESULT result = message->Parameters()
                                       .Implementation<OCDM::ISessionExt>()
                                       ->GetChallengeDataExt(challenge, challengeSize, isLDL);
    ...
    [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED,
        Core::ProxyType<RPC::InvokeMessage>& message) {
        //
        // virtual OCDM_RESULT StoreLicenseData(const uint8_t licenseData[],
        // uint32_t licenseDataSize, uint8_t * secureStopId) = 0;
        //
        RPC::Data::Frame::Reader parameters(message->Parameters().Reader());
        RPC::Data::Frame::Writer response(message->Response().Writer());
        ...
        OCDM::OCDM_RESULT result = message->Parameters()
                                       .Implementation<OCDM::ISessionExt>()
                                       ->StoreLicenseData(licenseData, licenseDataSize, secureStopId);
...
typedef ProxyStub::UnknownStubType<OCDM::IAccessorOCDM, AccesorOCDMStubMethods>
    AccessorOCDMStub;
typedef ProxyStub::UnknownStubType<OCDM::IAccessorOCDMExt,
    AccesorOCDMExtStubMethods>
    AccessorOCDMExtStub;
typedef ProxyStub::UnknownStubType<OCDM::IAccessorOCDM::INotification,
    AccesorOCDMNotificationStubMethods>
    AccessorOCDMNotificationStub;
typedef ProxyStub::UnknownStubType<OCDM::ISession::ICallback,
    CallbackStubMethods>
    CallbackStub;
typedef ProxyStub::UnknownStubType<OCDM::ISession, SessionStubMethods>
    SessionStub;
typedef ProxyStub::UnknownStubType<OCDM::ISessionExt, SessionExtStubMethods>
    SessionExtStub;
...
class AccessorOCDMProxy
    : public ProxyStub::UnknownProxyType<OCDM::IAccessorOCDM> {
public:
    AccessorOCDMProxy(const Core::ProxyType<Core::IPCChannel>& channel,
...
public:
    ...
    virtual OCDM::ISession* Session(const std::string sessionId)
    {
        ...
        if (Invoke(newMessage) == Core::ERROR_NONE) {
            result = reinterpret_cast<OCDM::ISession*>(
                Interface(newMessage->Response().Reader().Number<void*>(),
                    OCDM::ISession::ID));
        }
    ...
    CreateSession(const string keySystem, const int32_t licenseType,
        const string initDataType, const uint8_t* initData,
        ...
        OCDM::ISession*& session) override
    {
        ...
        if (Invoke(newMessage) == Core::ERROR_NONE) {
            ...
            session = reinterpret_cast<OCDM::ISession*>(
                Interface(reader.Number<void*>(), OCDM::ISession::ID));
...
class AccessorOCDMExtProxy
    : public ProxyStub::UnknownProxyType<OCDM::IAccessorOCDMExt> {
public:
    AccessorOCDMExtProxy(const Core::ProxyType<Core::IPCChannel>& channel,
        void* implementation, const bool otherSideInformed)
        : BaseClass(channel, implementation, otherSideInformed)
    {
    }
...
public:
        ...
        OCDM::ISessionExt*& session) override
    {
        ...
        if (Invoke(newMessage) == ERROR_NONE) {
            ...
            session = reinterpret_cast<OCDM::ISessionExt*>(
                Interface(reader.Number<void*>(), OCDM::ISessionExt::ID));
    ...
    virtual uint32_t
    GetLdlSessionLimit(const std::string& keySystem) const override
    {
        IPCMessage newMessage(BaseClass::Message(3));
        RPC::Data::Frame::Writer writer(newMessage->Parameters().Writer());
        writer.Text(keySystem);
    ...
    virtual OCDM::OCDM_RESULT GetKeyStoreHash(const std::string& keySystem,
        uint8_t keyStoreHash[],
    ...
    virtual OCDM::OCDM_RESULT GetSecureStoreHash(const std::string& keySystem,
        uint8_t secureStoreHash[],
...
class AccessorOCDMNotificationProxy
    : public ProxyStub::UnknownProxyType<OCDM::IAccessorOCDM::INotification> {
public:
    AccessorOCDMNotificationProxy(
        const Core::ProxyType<Core::IPCChannel>& channel, void* implementation,
...
class CallbackProxy
    : public ProxyStub::UnknownProxyType<OCDM::ISession::ICallback> {
public:
    CallbackProxy(const Core::ProxyType<Core::IPCChannel>& channel,
        void* implementation, const bool otherSideInformed)
        : BaseClass(channel, implementation, otherSideInformed)
    {
    }
...
public:
    ...
    // Event fired when a key message is successfully created.
    //
    virtual void OnKeyMessage(const uint8_t* keyMessage, const uint16_t length,
        const string URL)
    {
        IPCMessage newMessage(BaseClass::Message(0));
        RPC::Data::Frame::Writer writer(newMessage->Parameters().Writer());
    ...
    // Event fired when MediaKeySession encounters an error.
    //
    virtual void OnKeyError(const int16_t error, const OCDM::OCDM_RESULT sysError,
...
public:
    SessionProxy(const Core::ProxyType<Core::IPCChannel>& channel,
        void* implementation, const bool otherSideInformed)
        : BaseClass(channel, implementation, otherSideInformed)
    {
    }
...
public:
    ...
    // Process a key message response.
    //
    virtual void Update(const uint8_t* keyMessage,
        const uint16_t keyLength) override
    {
        IPCMessage newMessage(BaseClass::Message(1));
        RPC::Data::Frame::Writer writer(newMessage->Parameters().Writer());
...
public:
    SessionExtProxy(const Core::ProxyType<Core::IPCChannel>& channel,
        void* implementation, const bool otherSideInformed)
        : BaseClass(channel, implementation, otherSideInformed)
    {
    }
...
public:
    ...
    virtual OCDM::OCDM_RESULT SetDrmHeader(const uint8_t drmHeader[],
        uint32_t drmHeaderLength) override
    {
        IPCMessage newMessage(BaseClass::Message(7));
        RPC::Data::Frame::Writer writer(newMessage->Parameters().Writer());
    ...
    virtual OCDM::OCDM_RESULT GetChallengeDataExt(uint8_t* challenge,
    ...
    virtual OCDM::OCDM_RESULT StoreLicenseData(const uint8_t licenseData[],
...
// -------------------------------------------------------------------------------------------
// These proxy stubs are "loaded" by the next method, which needs to be
// explicitely called
// since the interface is a dedicated interface and needs loading, if required
// by a
...
public:
    Instantiation()
    {
        RPC::Administrator::Instance()
            .Announce<OCDM::ISession::ICallback, CallbackProxy, CallbackStub>();
        RPC::Administrator::Instance()
            .Announce<OCDM::ISession, SessionProxy, SessionStub>();
        RPC::Administrator::Instance()
            .Announce<OCDM::ISessionExt, SessionExtProxy, SessionExtStub>();
        RPC::Administrator::Instance()
            .Announce<OCDM::IAccessorOCDM, AccessorOCDMProxy, AccessorOCDMStub>();
        RPC::Administrator::Instance()
            .Announce<OCDM::IAccessorOCDMExt, AccessorOCDMExtProxy,
                AccessorOCDMExtStub>();
        RPC::Administrator::Instance()
            .Announce<OCDM::IAccessorOCDM::INotification,
                AccessorOCDMNotificationProxy,
                AccessorOCDMNotificationStub>();
    }
