...
namespace Exchange {
    ...
    struct EXTERNAL IGraphicsProperties : virtual public Core::IUnknown {
        ...
        // @property
        // @brief Total graphics memory
        // @param totalgpuram: Total GPU RAM
        virtual uint32_t TotalGpuRam(uint64_t& totalgpuram /* @out*/) const = 0;

        // @property
        // @brief Graphics memory free
        // @param freegpuram: free GPU ram
        virtual uint32_t FreeGpuRam(uint64_t& freegpuram /* @out*/) const = 0;
    };
    ...
    struct EXTERNAL IConnectionProperties : virtual public Core::IUnknown {
        ...
        // @param length: length of edid
        // @param data: edid data
    ...
    struct EXTERNAL IHDRProperties : virtual public Core::IUnknown {
        ...
        virtual uint32_t TVCapabilities(IHDRIterator* type /* out */) const;

        // @property
        // @brief HDR formats supported by STB
        // @return HDRType: array of HDR formats
        virtual uint32_t STBCapabilities(IHDRIterator* type /* out */) const;
