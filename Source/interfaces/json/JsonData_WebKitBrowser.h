...
// C++ classes for WebKit Browser JSON-RPC API.
// Generated automatically from 'WebKitBrowserAPI.json'.
...
namespace JsonData {
    ...
    namespace WebKitBrowser {
        ...
        public:
            Core::JSON::String Url; // The currently loaded URL in the browser
