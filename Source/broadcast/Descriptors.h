...
namespace Descriptors {
    ...
    public:
        ...
        NetworkName(const NetworkName& copy) : _data(copy._data) {
        }
        NetworkName(const MPEG::Descriptor& copy) : _data(copy) {
        }
        ~NetworkName() {
        }
    ...
    public:
        SatelliteDeliverySystem() : _data() {
        }
        SatelliteDeliverySystem(const SatelliteDeliverySystem& copy) : _data(copy._data) {
        }
        SatelliteDeliverySystem(const MPEG::Descriptor& copy) : _data(copy) {
        }
    ...
    public:
        CableDeliverySystem() : _data() {
        }
        CableDeliverySystem(const CableDeliverySystem& copy) : _data(copy._data) {
        }
        CableDeliverySystem(const MPEG::Descriptor& copy) : _data(copy) {
        }
        ~CableDeliverySystem() {
        }
    ...
    public:
        ...
        Service(const Service& copy) : _data(copy._data) {
        }
        Service(const MPEG::Descriptor& copy) : _data(copy) {
        }
        ~Service() {
        }
