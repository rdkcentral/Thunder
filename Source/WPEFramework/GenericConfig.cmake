...
set(CONTAINER_SEARCH_PATH "${CMAKE_INSTALL_PREFIX}/share/${NAMESPACE}" CACHE STRING "ProcessContainer search path")
...
if(PROCESSCONTAINERS)
    map()
        kv(searchpath ${CONTAINER_SEARCH_PATH})
    end()
    ans(PC_CONFIG)
    map_append(${CONFIG} processcontainers ${PC_CONFIG})
endif()
