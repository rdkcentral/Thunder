...
![Sequence Diagram showing multiple setters and getters](ExampleStaticDynamic1.png)
...
![Sequence Diagram showing Notification after update without locking](ExampleStaticDynamic2.png)
